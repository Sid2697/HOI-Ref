...
from vlm4hoi.conversation.conversation import StoppingCriteriaSub

class VLM4HOIBase(BaseModel):
    """
    Base class for VLM4HOI model. 
    """
    ...
    def forward(self, samples, reduction='mean'):
        ...
        loss = outputs.loss
        logging.info('Time taken by models pass: {}'.format(time.time() - start))
